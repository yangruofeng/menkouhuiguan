...
$(document).ready(function(){
    yo.bindXxAmountEvent();
});
yo.bindXxAmountEvent=function(_after_blur){
    $(".xx-amount").unbind('focus').on('focus',function(){
        if($(this).data("value")){
            $(this).val($(this).data('value'));
        }
    });
    $(".xx-amount").unbind('blur').on('blur',function(){
...
yo.resetXxAmountAsInputState=function(){
    $(".xx-amount").each(function(){
        if($(this).data("value")){
            $(this).val($(this).data('value'));
        }
    });
