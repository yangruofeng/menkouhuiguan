...
.script-form {width: 600px;margin: 0 auto;margin-top: 30px;}
...
<div class="script-form">
  ...
  <br>
  <label for="">Password: </label><input class="form-control" id="password" type="password" name="password" value="">
  <br />
...
<script>
  $('#scriptSubmitBtn').click(function(){
    ...
    $.ajax({
      ...
      type: 'post',
      data: {text: _sql_text,password:_password},
      dataType: 'json',
